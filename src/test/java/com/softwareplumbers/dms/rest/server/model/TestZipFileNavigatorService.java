...
public class TestZipFileNavigatorService {
    ...
    public void testListSimpleZipfile() throws IOException, InvalidObjectName {
        ...
        StreamableDocumentPart part1 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.add("testdoc.docx"));
        StreamableDocumentPart part2 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.add("testdoc_outlook2010.msg"));
        StreamableDocumentPart part3 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.add("test1.txt"));
    ...
    public void testListZipDir() throws IOException, InvalidObjectName  {
        ...
        StreamableDocumentPart part1 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.addDocumentPaths("test","test1.txt"));
        StreamableDocumentPart part2 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.addDocumentPaths("test","test2.txt"));        
        StreamableDocumentPart part3 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.addDocumentPaths("test","subdir","testdoc.docx"));
