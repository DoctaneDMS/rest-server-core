...
public class TestZipFileNavigatorService {
    ...
    public void testListSimpleZipfile() throws IOException, InvalidObjectName {
        ...
        StreamableDocumentPart part1 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.addPartPath("testdoc.docx"));
        StreamableDocumentPart part2 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.addPartPath("testdoc_outlook2010.msg"));
        StreamableDocumentPart part3 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.addPartPath("test1.txt"));
        assertEquals("testdoc.docx", part1.getName().part.getName().get());
        assertEquals("testdoc_outlook2010.msg", part2.getName().part.getName().get());
        assertEquals("test1.txt", part3.getName().part.getName().get());
    ...
    public void testListZipDir() throws IOException, InvalidObjectName  {
        ...
        StreamableDocumentPart part1 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.addPartPaths("test","test1.txt"));
        StreamableDocumentPart part2 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.addPartPaths("test","test2.txt"));        
        StreamableDocumentPart part3 = (StreamableDocumentPart)parts.getChild(null, RepositoryPath.ROOT.addPartPaths("test","subdir","testdoc.docx"));
        assertEquals("test1.txt", part1.getName().part.getName().get());
        assertEquals("test2.txt", part2.getName().part.getName().get());
        assertEquals("testdoc.docx", part3.getName().part.getName().get());
