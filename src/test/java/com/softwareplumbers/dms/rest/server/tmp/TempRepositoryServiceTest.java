...
public class TempRepositoryServiceTest extends BaseRepositoryServiceTest {
	...
	public void testListWorkspaces() throws InvalidDocumentId, InvalidWorkspace, InvalidWorkspaceState {
		...
		assertEquals(2,repository.service.listWorkspaces(repository.ref1.id, null, Query.UNBOUNDED).count());
		assertEquals(1,repository.service.listWorkspaces(repository.ref2.id, null, Query.UNBOUNDED).count());
		assertEquals(1,repository.service.listWorkspaces(repository.ref3.id, null, Query.UNBOUNDED).count());
	}
